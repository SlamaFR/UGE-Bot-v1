            ...
            textChannel.sendMessage(
                    new EmbedBuilder()
                            ...
                            .addField("Syntaxe", "Une ligne est divisée en colonnes par le caractère `;`. " +
                                    ...
                                    "Pour dessiner une case vide avec les bordures, il faut écrire un et un seul espace.", false)
                            .addField("Exemple 1", "`!table \";Colonne 1;Colonne 2\" \"Ligne 1;Val 1;Val 2\" ou;comme;ceci`\n" +
                                    "```\n" +
                                    "          +-----------+-----------+\n" +
                                    "          | Colonne 1 | Colonne 2 |\n" +
                                    "+---------+-----------+-----------+\n" +
                                    ...
                                    "+---------+-----------+-----------+\n" +
                                    "```", false)
                            .addField("Exemple 2", "`!table \" ;Colonne 1;Colonne 2\" \"Ligne 1;Val 1;Val 2\" ou;comme;ceci`\n" +
                                    "```\n" +
                                    "+---------+-----------+-----------+\n" +
                                    "|         | Colonne 1 | Colonne 2 |\n" +
                                    "+---------+-----------+-----------+\n" +
